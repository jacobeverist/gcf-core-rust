...
//! let mut input_encoder = DiscreteTransformer::new(10, 1024, 2, 0);
...
//! learner.input.add_child(Rc::new(RefCell::new(input_encoder.output)), 0);
//! learner.context.add_child(Rc::new(RefCell::new(context_encoder.output)), 0);
//! learner.init().unwrap();
//!
//! // Process patterns
