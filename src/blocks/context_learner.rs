...
impl crate::network_config::BlockConfigurable for ContextLearner {
    fn to_config(&self) -> crate::network_config::BlockConfig {
        crate::network_config::BlockConfig::ContextLearner {
            num_c: self.num_c,
